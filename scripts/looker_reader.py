  ...
  "dataRequest": [
    {
      "requestContext": {
        "reportContext": {
          "reportId": "2a3eaf2b-5c24-47e1-b447-eb33cd2c12bc",
          "pageId": "80267794",
          "mode": 1,
          "componentId": "cd-059c10azwd",
      ...
      "datasetSpec": {
        "dataset": [
          {
            "datasourceId": "dae10274-330b-4bc8-bd00-66c05707bdec",
            "revisionNumber": 0,
            "parameterOverrides": []
          }
        ],
        "queryFields": [
          ...
          },
          {
            ...
            "tableNs": "t0",
            "dataTransformation": {
              "sourceFieldName": "calc_lubs78d1wd",
              "aggregation": 6
            }
          },
          {
            ...
            "dataTransformation": {
              "sourceFieldName": "calc_z7mnf7d1wd",
              "aggregation": 6
            }
          },
          {
            ...
            "dataTransformation": {
              "sourceFieldName": "calc_mh1mq9p4wd",
              "aggregation": 6
            }
          },
          {
            ...
            "dataTransformation": {
              "sourceFieldName": "calc_sjkirbq4wd",
              "aggregation": 6
            }
          },
          {
            ...
            "dataTransformation": {
              "sourceFieldName": "_admob_revenue_",
              "aggregation": 6
            }
          },
          {
            ...
            "dataTransformation": {
              "sourceFieldName": "_google_spend_",
              "aggregation": 6
            }
          },
          {
            ...
            "dataTransformation": {
              "sourceFieldName": "_mintegral_spend_",
              "aggregation": 6
            }
          },
          {
            ...
            "dataTransformation": {
              "sourceFieldName": "_tiktok_spend_",
              "aggregation": 6
            }
          },
          {
            ...
            "dataTransformation": {
              "sourceFieldName": "_facebook_spend_",
              "aggregation": 6
            }
          },
          {
            ...
            "dataTransformation": {
              "sourceFieldName": "_conversion_rate_",
              "aggregation": 6
            }
          }
        ],
      ...
      "retryHints": {
        ...
        "isLastRetry": False,
        "retryCount": 0,
        "originalRequestId": "cd-059c10azwd_0_0"
      }
    }
  ]
}
...
def fetch_looker_data():
    ...
    xsrf_token = os.environ.get("LOOKER_XSRF_TOKEN", DEFAULT_XSRF)
    ...
    payload = json.dumps(LOOKER_PAYLOAD).encode("utf-8")
    ...
    try:
        with urllib.request.urlopen(req) as response:
            ...
            # We need to strip it before parsing JSON
            if response_data.startswith(")]}'"):
                response_data = response_data[4:].strip()
                
            return json.loads(response_data)
    except urllib.error.URLError as e:
        print(f"Error fetching data from Looker Studio: {e}")
        if hasattr(e, 'read'):
